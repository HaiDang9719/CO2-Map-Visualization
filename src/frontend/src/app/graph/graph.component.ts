...
export class GraphComponent implements OnInit {
    ...
    init_svg() {
        this.svg = d3.select(this.htmlElement).select('#graphCountry')
            // .attr('width', '600px')
            // .attr('height', '400px')
    ...
    generate_graph(dataV: any, name: string): void {
        ...
        const yValue = Object.keys(dataInit).slice(1,41);
...
//             this.svg.selectAll('*').remove();
//             this.countrySelection = name;
//             const data = this.temp?.features.filter((ele: any) => ele.properties.country === name)[0];
//             this.generate_graph(data)
//
//         })
//         // this.mapvisService.load_graphData().pipe(take(2)).subscribe((response: any) => {
//         //   const objs = d3.csvParse(response);
...
//
//     init_svg() {
//         console.log(d3.select(this.htmlElement));
//         this.svg = d3.select(this.htmlElement).select('#graphCountry')
//             // .attr('width', '600px')
//             // .attr('height', '400px')
//             .attr("viewBox", "0 0 " + 600 + " " + 300)
...
//     }
//
//     generate_graph(dataInit: any): void {
//         const data = dataInit.properties.averageTemperatures;
//
...
//             })
//             .y(function (d: any) {
//                 return y2(d.averageTemperature);
//             });
//
...
//             .attr("transform", "translate(" + margin2.left + "," + margin2.top + ")");
//         // @ts-ignore
//         x.domain(d3.extent(data, (d: any) => {
//             return d.year;
//         }));
//         // @ts-ignore
//         y.domain([d3.min(data, function (d: any) {
